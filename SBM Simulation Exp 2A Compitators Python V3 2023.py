...
sizes_A1 = [100]*5 # size --block sizes
...
#AD.to_csv("~/Library/CloudStorage/OneDrive-Personal/Transportation Network/R code/Simulation/Comparison/Data/SBM_Cobmined_RegularAnomaly_Exp2A.csv")

#AD.to_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/SBM_Cobmined_RegularAnomaly_Exp2A.csv")
...
D1_Frob1.to_csv("~/Library/CloudStorage/OneDrive-Personal/Transportation Network/R code/Simulation/Comparison/Data/D_Frob_SBM_exp2A.csv")
D1_Deltacon1.to_csv("~/Library/CloudStorage/OneDrive-Personal/Transportation Network/R code/Simulation/Comparison/Data/D_Deltacon_SBM_exp2A.csv")
D1_HannMik.to_csv("~/Library/CloudStorage/OneDrive-Personal/Transportation Network/R code/Simulation/Comparison/Data/D_HannMik_SBM_exp2A.csv")



D1_Frob1.to_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/D_Frob_SBM_exp2.csv")
D1_Deltacon1.to_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/D_Deltacon_SBM_exp2.csv")
D1_HannMik.to_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/D_HannMik_SBM_exp2.csv")
