...
data = pd.read_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/SBM_PD_Comb_Exp2A.csv", header=None)
print(data)
...
DF.to_csv("C:/Users/adey/OneDrive/Transportation Network/R code/Simulation/Comparison/Data/Exp2A_PI_SBM.csv")
