...
#D0<- read.table("C:/Users/asimi/OneDrive/Transportation Network/R code/Real Data Analysis/UCI Message/UCI_Text_Data_AA.txt", quote="\"", comment.char="")
D0<- read.table("~/Library/CloudStorage/OneDrive-Personal/Transportation Network/R code/Real Data Analysis/UCI Message/UCI_Text_Data_AA.txt", quote="\"", comment.char="")
head(D0)
...
setwd("C:/Users/asimi/OneDrive/Transportation Network/R code/")
...
#write.table(betti_1, "C:/Users/asimi/OneDrive/Transportation Network/R code/Real Data Analysis/UCI Message/Betti_1_UCI_message.csv", col.names = FALSE, row.names = FALSE, sep = ",")


#Betti<-read.table("C:/Users/adey/OneDrive/Transportation Network/R code/Real Data Analysis/UCI Message/Betti_1_UCI_message.csv", header = FALSE, sep = ",")

Betti<-read.table("C:/Users/asimi/OneDrive/Transportation Network/R code/Real Data Analysis/UCI Message/Betti_1_UCI_message.csv", header = FALSE, sep = ",")
dim(Betti)
...
#write.table(D1, "C:/Users/asimi/OneDrive/Transportation Network/R code/Real Data Analysis/UCI Message/PD_Comb_UCI_message.csv", col.names = FALSE, row.names = FALSE, sep = ",")
